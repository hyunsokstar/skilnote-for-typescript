...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CommentForPageForSkilNote3',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='TempMyShortCutForSkilNote3',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='skilnote3.categoryforskilnote3')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skilnote3.typeforskilnote3')),
            ],
        ),
        migrations.CreateModel(
            name='TempMyShortCutForBackEndForSkilNote3',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=120)),
                ('content1', models.CharField(blank=True, max_length=180)),
        ...
        migrations.CreateModel(
            name='RecommandationUserAboutSkilNote3',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='skilnote3/%y%m%d')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='skilnote3.categoryforskilnote3')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skilnote3.typeforskilnote3')),
            ],
        ...
        migrations.CreateModel(
            name='CommentForShortCutForSkilNote3',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('shortcut', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skilnote3.myshortcutforskilnote3')),
            ],
        ),
        migrations.CreateModel(
            name='CategoryNickForSkilNote3',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
