...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CommentForPageForSkilNote2',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='TempMyShortCutForSkilNote2',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='skilnote2.categoryforskilnote2')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skilnote2.typeforskilnote2')),
            ],
        ),
        migrations.CreateModel(
            name='TempMyShortCutForBackEndForSkilNote2',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=120)),
                ('content1', models.CharField(blank=True, max_length=180)),
        ...
        migrations.CreateModel(
            name='RecommandationUserAboutSkillNote2',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='skilnote2/%y%m%d')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='skilnote2.categoryforskilnote2')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skilnote2.typeforskilnote2')),
            ],
        ...
        migrations.CreateModel(
            name='LikeGuestBookForSkilNote2',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='CommentForShortCutForSkilNote2',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('shortcut', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skilnote2.myshortcutforskilnote2')),
            ],
        ),
        migrations.CreateModel(
            name='CategoryNickForSkilNote2',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
